...
const StoryCreateLink = () => {
  ...
  return (
    <Link to={`${ROUTES_PATH.story.create}`}>
      <StyledImageWrapper>
        <ImageWithPlaceHolder src={user?.avatar || ''} alt={user?.name ?? 'story-image'} />
      </StyledImageWrapper>
...
export default switchRenderAuthenticatedComponent(React.memo(StoryCreateLink))
